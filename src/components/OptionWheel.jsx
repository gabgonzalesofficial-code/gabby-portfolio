...
const OptionWheel = ({
  ...
  // Lets an external source (e.g. scroll position) drive the wheel's
  // position without going through applyTarget, so it doesn't re-fire
  // onChange and loop back into whatever triggered the sync.
  useEffect(() => {
    if (activeIndex == null || activeIndex === selectedRef.current) return;
