...
export const portfolioData = {
  ...
  certifications: [
    { name: 'Certificate of Completion', issuer: 'Vjal Institure', year: '2026' },
    { name: 'Top Performer', issuer: 'Proweaver Inc.', year: '2025' },
    { name: 'Top Performer', issuer: 'Proweaver Inc.', year: '2024' },
    { name: 'Certification 4', issuer: 'Organization 4', year: '2023' },
    { name: 'Certification 5', issuer: 'Organization 5', year: '2022' },
    { name: 'Certification 6', issuer: 'Organization 6', year: '2022' },
    { name: 'Certification 7', issuer: 'Organization 7', year: '2021' },
    { name: 'Certification 8', issuer: 'Organization 8', year: '2021' },
    { name: 'Certification 9', issuer: 'Organization 9', year: '2020' },
    { name: 'Certification 10', issuer: 'Organization 10', year: '2020' }
  ],
  ...
  projects: [
    ...
    { name: 'Roseatte', description: 'A WordPress website I made for my girlfriend using a custom theme', url: 'tobedeployed2.com' },
    { name: 'Form Conversion Tool', description: 'A tool I developed using react to for form conversion using reactJS and Vite', url: 'https://formconversiontool.vercel.app/' },
    { name: 'Knowledge Base App', description: 'An app I developed to be used by my friends to share knowledge and resourece. Made using Next.js and Supabase', url: 'https://kb-app-five.vercel.app/' }
  ],
